...
import 'package:dietify/data/service/export_service.dart';
import 'package:dietify/data/service/file_service.dart';
import 'package:dietify/presentation/widgets/full_screan_video_player.dart';
          ...
          child: Column(
            children: [
              ...
              _buildAddButton(() {
                ...
                historyProvider.addItemToHistory(HistoryItem(
                    label: workout.name!,
                    date: DateTime.now(),
